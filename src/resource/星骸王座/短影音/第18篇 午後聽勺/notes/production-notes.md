...
- Output: `output/星骸王座-短影音-第18篇-午後聽勺-1080x1920.mp4`。
- Video: 60.000s，`1080x1920`，SAR `1:1`，DAR `9:16`，`30/1`。
- Audio: 60.000s，`aac`，`24000Hz`，channels `1`。
- Voice source: 50.192s；subtitle latest end 49.390s；CTA 6 秒保持無字幕導流頁。
- Mix volume: mean `-23.3 dB`，max `-7.2 dB`；no clipping。
