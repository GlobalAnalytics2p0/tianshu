...
選用 `這支勺子不是在救人，它在挑誰最像照護那雙手。`，因為它最先把怪事和代價說清，不靠作品術語撐鉤子。

## 分鏡意圖

- 視覺主軸：分湯勺、熱氣、熱布架、照護棚、桌邊分藥與群眾視線。
...
- Voice source：47.096 秒，低於 54 秒字幕安全線，沒有被 final MP4 截斷。
- 字幕最後 cue：00:00:46,296；CTA 之前已結束。
