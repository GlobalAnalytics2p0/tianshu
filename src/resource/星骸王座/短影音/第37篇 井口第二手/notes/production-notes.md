...
選用 `你還沒開口，他就先把第二桶接走了。`，因為它最先把怪事和代價說清，不靠作品術語撐鉤子。

## 分鏡意圖

- 視覺主軸：井口、繩結、共肩木環、兩桶同時失手、孩子先補手。
...
- Voice source：45.896 秒，低於 54 秒字幕安全線，沒有被 final MP4 截斷。
- 字幕最後 cue：00:00:45,096；CTA 之前已結束。
