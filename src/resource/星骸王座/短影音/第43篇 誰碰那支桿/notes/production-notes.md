...
選用 `最危險的，不是病人，是那支誰都會順手扶正的公用器具。`，因為它最先把怪事和代價說清，不靠作品術語撐鉤子。

## 分鏡意圖

- 視覺主軸：破簾、長桿、公用水桶、矮凳、灰上手痕與群體圍看。
...
- Voice source：49.424 秒，低於 54 秒字幕安全線，沒有被 final MP4 截斷。
- 字幕最後 cue：00:00:48,624；CTA 之前已結束。
