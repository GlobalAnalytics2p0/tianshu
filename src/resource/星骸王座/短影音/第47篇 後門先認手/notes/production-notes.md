...
選用 `那扇後門不認臉，它先認你摸石頭的手。`，因為它最先把怪事和代價說清，不靠作品術語撐鉤子。

## 分鏡意圖

- 視覺主軸：白石、門牌、夜裡後門、守更燈火、手伸向石頭與門邊回望。
...
- Voice source：48.944 秒，低於 54 秒字幕安全線，沒有被 final MP4 截斷。
- 字幕最後 cue：00:00:48,144；CTA 之前已結束。
