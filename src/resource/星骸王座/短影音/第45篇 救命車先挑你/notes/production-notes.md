...
選用 `這台救命車會自己挑人站左前。`，因為它最先把怪事和代價說清，不靠作品術語撐鉤子。

## 分鏡意圖

- 視覺主軸：擁擠街口、推送重物、左前受力、車轅木痕、泥坑與群體換位。
...
- Voice source：45.272 秒，低於 54 秒字幕安全線，沒有被 final MP4 截斷。
- 字幕最後 cue：00:00:44,472；CTA 之前已結束。
