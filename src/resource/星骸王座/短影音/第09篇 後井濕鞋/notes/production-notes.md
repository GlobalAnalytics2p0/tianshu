...
- Output: `output/星骸王座-短影音-第09篇-後井濕鞋-1080x1920.mp4`。
- Video: 60.000s，`1080,1920,1:1,9:16,30/1`。
- Audio: 60.000s，`aac,24000,1`，無背景音、無外部音樂曲目。
- Voice source: `voice/edge-acted-narration.m4a`，55.496s；final MP4 沒有截斷旁白。
- Mix volume: mean `-22.8 dB`，max `-7.4 dB`；no clipping。
