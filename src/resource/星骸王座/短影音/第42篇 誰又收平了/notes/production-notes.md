...
- 主鉤子：有人不搶第一手，也不碰最後一手，卻總能把整個亂局悄悄收平。
- 素材起點：第42章 餘手留痕。
...
選用 `有人不搶第一手，也不碰最後一手，卻總能把整個亂局悄悄收平。`，因為它最先把怪事和代價說清，不靠作品術語撐鉤子。

## 分鏡意圖

- 視覺主軸：暖肩墊、灰痕、亂處留痕、扶正與掖被角、洗布槽與後井公物。
...
- Voice source：53.792 秒，低於 54 秒字幕安全線，沒有被 final MP4 截斷。
- 字幕最後 cue：00:00:52,992；CTA 之前已結束。
- 聲線：旁白固定 HsiaoChen；男性台詞沿用 Yunxi fallback，避免角色性別錯位。
