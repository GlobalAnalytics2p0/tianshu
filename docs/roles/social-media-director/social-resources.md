...
本檔集中保存目前天書平台可用的社群與推廣資源。不要在此保存密碼、token、cookie、OTP 或任何敏感登入資訊。
...
| 主要 active title | `星骸王座`、`灰塔觀測者`、`雪刃照孤城`、`凌晨三點的演算法`、`大明墨工` | 六小時排程更新與推廣優先 |
...
- 每個平台獨立發布，不使用同步分享。
- Instagram 圖片品質是轉換關鍵，發布前必須人工視覺檢查。
- Threads 文案要像自然推薦與連載提醒，不寫成長公告。
- Facebook 可以承載較完整背景、故事賣點與連結。
