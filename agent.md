...
- 2026-06-08 `星骸王座` publication update: Chapters 1 and 2 have both been made into video/audiobook assets and are locked against routine text edits. Future review/revision may start from Chapter 3 onward unless the user explicitly authorizes post-publication correction.
...
- 2026-06-08 chapter-title rule: unpublished and newly generated chapter titles should be short enough for website cards, audiobook assets, and YouTube metadata. Prefer 3-6 Traditional Chinese characters and cap at 7 characters unless the user explicitly approves a longer title. Published video/audiobook titles are locked with their public assets.
